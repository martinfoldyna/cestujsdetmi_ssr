    ...
    <Fragment>
      ...
      >
        <>
          <p>
            Denně navštěvuje portál Cestuj s dětmi.cz více než 2 tisíce
            uživatelů, kteří hledají tipy na dovolenou nebo na volný čas po celé
            České republice.
          </p>
          ...
          <p>
            ...
            přehledné administrace. Případní budoucí klienti se tak snadno a
            rychle seznámí s poskytovanou nabídkou, prohlédnou si fotografie a
            získají představu o nabízených službách. Zároveň mohou ihned pomocí
            přímého prolinku přejít na Vaše webové stránky.
          </p>
        </>
      </HeadingWithIcon>
          ...
          <Row>
            <Col md={6} style={{ marginBottom: "2em" }} className="pl-0">
              <div className="plan-card">
                ...
                <p>
                  Krátkodobé zveřejnění Vašeho PR článku ( např. s pozvánkou na
                  pořádané akce, pogramy, slevové balíčky apod. ) na hlavní
                ...
                <p>
                  Po uplynutí placeného období zůstává článek na našem serveru v
                  archivu. Článek na hlavní straně nerotuje s ostatními články,
                  zůstává v pevném ukotvení.
                </p>{" "}
                <p>Zveřejňujeme max. 6 AKTUALIT v daném období.</p>{" "}
                <p>
                  Průměrná návštěvnost portálu je 2000 uživatelů dennně, ruční
                  zaindexování článku na Google.cz a Seznam.cz, anotace z hlavní
                  strany portálu (HP).
                </p>{" "}
                <p>
                ...
                <p>
                  Pokud Vás nabídka zaujala, pak určitě neváhejte a kontaktujte
                  nás info@cestujsdetmi.cz.
                </p>
              </div>
            </Col>
            <Col md={6} style={{ marginBottom: "2em" }} className="p-0">
              <div className="plan-card">
                ...
                <p>
                  PR článek je umístěn na dobu jednoho roku v sekci RADY A TIPY
                  – Cestuj s dětmi doporučuje ( zelená záložka v menu na hlavní
                  straně ). PR článek je umístěn na dobu jednoho roku v sekci
                  RADY A TIPY – Cestuj s dětmi doporučuje ( zelená záložka v
                  menu na hlavní straně ).
                </p>{" "}
                <p>
                ...
                <p>
                  Po dobu zveřejnění rotuje PR článek na hlavní straně portálu v
                  sekci NEJČTENĚJŠÍ ČLÁNKY a tím je uživatelům ještě více na
                  očích.
                </p>{" "}
                <p>
                  Po uplynutí placeného období bude na Vás, zda se rozhodnete
                  spolupráci prodloužit o další rok nebo bude PR článek umístěn
                  do archivu ( zachování linkbuildingu ).
                </p>{" "}
                ...
                <p>
                  Pokud Vás nabídka zaujala, pak určitě neváhejte a kontaktujte
                  nás{" "}
                  <a href="mailto:info@cestujsdetmi.cz" className="text-yellow">
            ...
            <Col md={6}>
              <div className="plan-card">
                ...
                <p>
                  CK Blue Style, CK Fischer, firma Topgal, Generali pojišťovna,
                  TravelPortál.cz, ePojištění, Zoznam.sk a mnoho dalších.
                </p>
              </div>
            </Col>
          </Row>
