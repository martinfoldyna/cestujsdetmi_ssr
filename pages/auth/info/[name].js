...
const ObjednatObjektInfo = ({
  ...
  const getObjekt = () => {
    setObjekt(user?.objekty?.find((objekt) => objekt.hodnota === name));
  };
  ...
  const onSubmitGeneral = (data) => {
    ...
    if (objekt) {
      handleObjekt(infoFinal, previewImages, "update", objekt.id, history);
    } else {
                      ...
                      <>
                        ...
                        <div className="location-options border-grey">
                          {loadingGeo ? (
                            ...
                            openGeoOptions &&
                            geoResults?.features?.map((resultItem) => {
                              return (
                                <div
...
ObjednatObjektInfo.propTypes = {
  uploadObjekt: PropTypes.func.isRequired,
  uploadObjektInfo: PropTypes.func.isRequired,
  handleObjekt: PropTypes.func.isRequired,
  users: PropTypes.object.isRequired,
  kategorie: PropTypes.array,
  getCategories: PropTypes.func.isRequired,
  getSecondaryCategoriesWithParam: PropTypes.func.isRequired,
};
