    ...
    <div>
      ...
      <Section>
        <div className="bg-white border-grey last-minute-small">
          <h3 className="m-0">Rodinná výstava - Skřítci a trpaslíci</h3>
          <p>
